...
fit_craccoon_500 <- fit_null #is best model

sink("craccoon_fit_100.txt")
print(summary(fit_craccoon_100))
sink()


##notes for interpretation
##COYOTE-RACCOON
# at 100 buffer: imperv is the only model with with AIC <2 null model,
