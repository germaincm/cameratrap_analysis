...
fit_cdeer_2000 <- fit_multi4 #is best model
...
##COYOTE-DEER
# at 100 buffer: from the models with AIC <2 null model, LFT_dist has lowest AIC
#   but no significant effect
# at 500 buffer: from the models with AIC <2 null model, Fcon_PA has lowest AIC
#   but no significant effect
# at 2000 buffer: from the models with AIC < null model, Fdec_PA has lowest AIC
#   and near-significant effect: p value 0.098; after hierarchical selection, 
#   Fdec_PA + Fcon_PA have best AIC with Fdec_PA having a significant effect (0.046)
